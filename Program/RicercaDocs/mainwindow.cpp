...
/*
    Opens a Qt message box preventing data loss by unexpected application closure by user end, depending on user
    selection the Window may remain for further editing, saving the document or might dismiss changes and
